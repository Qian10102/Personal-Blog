export const site = {
  ...
  bioEn: [
    "Transport and Logistics student at Beihang University,",
    "interested in engineering practice, transport and logistics.",
  ].join(" "),
...
export const ui = {
  ...
  en: {
    ...
    next: "Next",
    language: "Language",
    searchHint: "Search titles, summaries, or tags…",
